function LineDrawer(curStage, shape, strokeColor, fillColor, lineStrokeWidth, initMousePosition, layer, marginLeft, marginTop) {
...
LineDrawer.prototype.draw = function (shape) {
    var self = this,
